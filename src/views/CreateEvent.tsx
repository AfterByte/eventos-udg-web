...
export default function CreateEvent() {
  ...
  const deleteTag = (e: any, tag: string) => {
    ...
    setTags([...tags.filter((tagS) => stringID !== tags.indexOf(tagS))]);
  };
                      ...
                      <form className="w-full">
                        <Form className="flex">
                          <div className="w-full xl:w-6/12 flex flex-col align-middle justify-center border-r">
                            ...
                            <button
                              type="submit"
                              className="font-small px-1 py-1 xl:font-semibold text-white mx-32 xl:mt-12 xl:py-2 bg-teal-500 rounded-md shadow-sm transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-100"
                            >
                              <p>Crear evento</p>
                            </button>
                          </div>
                          ...
                          <div className="w-full xl:w-6/12 border-l">
                            ...
                            <div className="flex w-full">
                              ...
                              <div className="flex flex-col w-3/12">
                                <p className="mt-6 mb-1 font-semibold text-center">
                                  Capacidad
                                </p>
                                <Field
                                  id="capacity"
                                      ...
                                      propsF.values.tags.length > 0 ? (
                                        propsF.values.tags.map((tag, index) => (
                                          <div className="items-center mr-8">
                                            ...
                                            <div className="flex">
                                              ...
                                              <button
                                                onClick={(e) =>
                                                  insert(e, arrayHelpers, index)
                                                }
                                              >
                                                <img
                                                  className="h-6 mr-3 rounded-full shadow-lg"
                                                  src={addIcon}
                                                  alt="AddIcon"
                                                />
                                              </button>
                                        ...
                                        >
                                          <div className="flex items-center mt-1 w-40">
                                            <p>Añade un tag</p>
                                            <img
                                              className="w-10 h-10 ml-2 rounded-full shadow-lg"
                                              src={addIcon}
                                              alt="AddIcon"
                                            />
                                          </div>
                            ...
                            <div className="flex flex-col w-full">
                              <div>
                                <p className="ml-4 mb-2 text-xl font-semibold">
                                  Participantes{" "}
                                  <span className="pl-4 text-base">
                                    (Anfitriones, expositores e invitados en
                                    general)
                                  </span>
                                </p>
                              </div>
                                ...
                                <div className="grid grid-cols-1 mx-4 mb-2">
                                  <div className="col-span-1 sm:col-span-2 flex ml-2 sm:ml-0 justify-center sm:justify-end">
                                    ...
                                    >
                                      ...
                                      <div className="hidden sm:grid mr-2 px-6 py-2 text-md font-normal text-white bg-teal-500 items-center">
                                        Buscar
                                      </div>
                                    </form>
                                  </div>
                              ...
                              <div className="pb-4">
                                <FieldArray
                                  ...
                                  render={(arrayHelpers) => (
                                    <div>
                                      {propsF.values.guests &&
                                      propsF.values.guests.length > 0 ? (
                                        propsF.values.guests.map(
                                          (guest, index) => (
                                            <div className="items-center">
                                              ...
                                              <div className="flex">
                                                ...
                                                >
                                                  <img
                                                    className="h-6 ml-4 rounded-full shadow-lg"
                                                    src={addIcon}
                                                    alt="AddIcon"
                                                  />
                                                </button>
