...
// formik
import { useFormik, Formik, Field, Form, FormikHelpers, FieldArray, setNestedObjectValues } from 'formik';
//icons
                ...
                <div className="col-span-6 xl:col-span-4 grid grid-cols-6 gap-4 bg-white ml-2 xl:ml-4 mr-2 rounded-md shadow-sm">
                  <div className="col-span-4 mt-2 ml-2">
                    <Form className="grid grid-cols-1">
                      ...
                      <Field id="name" name="name" placeholder="Nombre" className="border border-gray-500 rounded-sm py-2 px-2"/>
                    </Form>
                  </div>
                  <div className="col-span-2 mt-2">
                    <Form className="grid grid-cols-1">
                      <label htmlFor="capacity" className="text-xs pb-3 xl:text-base xl:pb-2">Capacidad máxima</label>
                      <Field id="capacity" name="capacity" placeholder="Capacidad máxima" className="border border-gray-500 rounded-sm py-2 px-2 mr-2"/>
                    </Form>
                  </div>
                  <div className="col-span-6 ml-2">
                    <Form className="grid grid-cols-1">
                      <label htmlFor="location" className="pb-2">Ubicación</label>
                      <Field id="location" name="location" placeholder="Ubicación" className="border border-gray-500 rounded-sm py-2 px-2 mr-2"/>
                    </Form>
                  </div>
                  {/* Google map */}
