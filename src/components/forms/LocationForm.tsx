  ...
  return (
    <div className="flex-grow overflow-auto p-4">
      ...
      >
        {({ setFieldValue }) => {
          return (
            <div className="xl:grid xl:grid-cols-7 h-full">
              <div className="xl:col-span-3 flex flex-col p-4 bg-white rounded">
                <Search
                  setMarker={setMarker}
              ...
              <div className="xl:col-span-4 p-4 xl:ml-4 xl:my-0 my-4 bg-white rounded">
                <LocationFields
                  address={address}
