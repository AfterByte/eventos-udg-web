        ...
        {propsF => (
          <form onSubmit={propsF.handleSubmit} className="xl:ml-64">
            <div className="bg-white rounded mt-48 xl:mt-64 sm:mx-56 px-4 pb-4 xl:py-12 w-auto grid grid-cols-1">
              ...
              <Form className="grid grid-cols-1 pt-4">
                <input id="image" type="file" name="image" onChange={propsF.handleChange("image")}/>
                <div className="flex items-center">
                  <label htmlFor="image" className="bg-white rounded-full shadow-lg bottom-0 right-0 mr-4 mb-4 transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-100"><img className="w-12 h-12" src={addIcon} alt="AddIcon"/></label>
                  <Field name="image" placeholder="selecciona una imagen" className="w-full"></Field>
                </div>
              </Form>
