              ...
              <div className="grid grid-cols-6 mt-4 xl:mt-4 sm:mt-6 mb-4 sm:mb-8 h-auto">
                ...
                <div className="col-span-6 xl:col-span-4 grid grid-cols-6 gap-4 bg-white ml-2 xl:ml-4 mr-2 rounded-md shadow-sm">
                  ...
                  <div className="col-span-2 mt-2">
                    <Form className="grid grid-cols-1">
                      ...
                      <Field
                        ...
                        className="border border-gray-500 rounded-sm py-2 px-2 mr-2"
                      />
                    </Form>
                  </div>
                  ...
                  <div className="col-span-6 ml-2 mr-2 h-64">
                    <GoogleMapReact
                      bootstrapURLKeys={{
                        key: process.env.REACT_APP_GOOGLE_MAPS_API_KEY as
                          | string
                          | "",
                      }}
                  ...
                  <div className="col-span-6 ml-2">
                    ...
                    <div className="grid grid-cols-12 my-4">
                      ...
                      <p className="col-span-8 text-sm">
                        Ubicaciones no pertenecientes a UDG pueden agregarse en
                        la agenda de Eventos de UDG pero se debe consultar
                        primero al encargado del lugar.
                      </p>
                    </div>
                  </div>
